...
public class BooleanOnOffType extends ParameterClassTypeClassConverter {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(BooleanOnOffType.class);
    ...
    public BooleanOnOffType(final ActionIn actionIn) {
        super(actionIn);
    }
    ...
    public void parameterFromDevice(final EventPublisher eventPublisher,
        ...
        final OnOffType type = booleanToOnOffType((Boolean) value);
        switch (getActionIn()) {
            case COMMAND:
