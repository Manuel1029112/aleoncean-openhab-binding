...
public class LongDecimalType extends ParameterClassTypeClassConverter {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(LongDecimalType.class);
    ...
    public LongDecimalType(final ActionIn actionIn) {
        super(actionIn);
    }
    ...
    public void parameterFromDevice(final EventPublisher eventPublisher,
        ...
        final DecimalType type = longToDecimalType((Long) value);
        switch (getActionIn()) {
            case COMMAND:
