...
public class DoubleDecimalType extends ParameterClassTypeClassConverter {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(DoubleDecimalType.class);
    ...
    public DoubleDecimalType(final ActionIn actionIn) {
        super(actionIn);
    }
    ...
    public void parameterFromDevice(final EventPublisher eventPublisher,
        ...
        final DecimalType type = doubleToDecimalType((Double) value);
        switch (getActionIn()) {
            case COMMAND:
